  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        angularls = {
          cmd = (function()
            local ng = vim.fn.stdpath 'data' .. '/mason/packages/angular-language-server/node_modules'
            local ngserver = vim.fn.has 'win32' == 1 and vim.fn.stdpath 'data' .. '/mason/bin/ngserver.cmd' or 'ngserver'
            return {
              ngserver,
              '--stdio',
              '--tsProbeLocations',
              ng,
              '--ngProbeLocations',
              ng .. '/@angular/language-server/node_modules',
            }
          end)(),
